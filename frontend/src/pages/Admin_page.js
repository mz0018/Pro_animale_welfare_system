...
const AdminPage = () => {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-green-50 p-6" style={{ backgroundImage: "url('/assets/vet-bg.jpg')", backgroundSize: "cover", backgroundPosition: "center" }}>
            <div className="w-full sm:w-11/12 md:w-1/2 lg:w-1/3 bg-white p-8 rounded-lg shadow-lg">
                {isSignUp ? (
                    <div>
                        <h1 className="text-2xl font-bold mb-6 text-green-700">Create Admin Account</h1>
                        <form onSubmit={signupAdmin} className="space-y-4">
                            ...
                            <button
                                type="submit"
                                className="w-full bg-green-500 text-white py-3 rounded-lg hover:bg-green-600 transition transform hover:scale-105"
                            >
                                Signup
                            </button>
                        </form>
                    ...
                    <div>
                        <h1 className="text-2xl font-bold mb-6 text-green-700">Signin Admin</h1>
